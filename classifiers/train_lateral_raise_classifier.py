...
DATASET_PATH = "data/rep_dataset_lateral_raises_features.csv"
...
def print_chosen_threshold_results(y_test, y_proba, threshold):
    ...
    save_confusion_matrix_plot(
        ...
        title=f"Lateral Raise Confusion Matrix - Threshold {threshold}",
        output_path=f"lateral_raise_confusion_matrix_threshold_{threshold}.png"
    )
...
def main():
    ...
    save_confusion_matrix_plot(
        ...
        title="Lateral Raise Confusion Matrix - Default Threshold",
        output_path="lateral_raise_confusion_matrix_default.png"
    )
